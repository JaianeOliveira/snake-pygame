...
def initialScreen():
    while True:
        ...
        point1X = (screenWidth/2) - 25
        point1Y = (screenHeight) - 250
        
        point2X= (screenWidth/2) - 25
        point2Y= (screenHeight) - 150
        
        point3X=(screenWidth/2) + 50
        point3Y=(screenHeight) - 200
        
        play = pygame.draw.polygon(screen, green, [(point1X, point1Y), (point2X, point2Y), (point3X, point3Y)])

        
        for event in pygame.event.get():
            if play.__getattribute__(event) == pygame.MOUSEBUTTONDOWN:
                gameLoop()
